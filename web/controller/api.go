...
func (a *APIController) multiupdateInbound(c *gin.Context) {
	a.inboundController.multiupdateInbound(c)
}
...
func (a *APIController) multiaddInboundClient(c *gin.Context) {
	a.inboundController.multiaddInboundClient(c)
}
...
func (a *APIController) multiupdateInboundClient(c *gin.Context) {
	a.inboundController.multiupdateInboundClient(c)
}
